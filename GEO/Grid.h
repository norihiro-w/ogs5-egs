...
public:
	 ...
	 *Furthermore the
	 * use can specify the maximum number of points per grid cell (in the
	 *average!).
	 *
	 ...
	 *belonging to, i.e.,
	 * the (internal) coordinates of the grid are computed. The method searches
	 *the actual
	 * grid cell and all its possible neighbors for the POINT object which has
	 *the smallest
