...
extern void GMSH2MSH(const char*, MeshLib::CFEMesh*);
// TK
extern void Mesh_Single_Surface(std::string surface_name,
                                const char* file_name_const_char);
// extern void Select_Nodes_Elements_by_TINFile(const char
// *file_name_const_char);
...
// OK
extern MeshLib::CFEMesh* MSHGet(const std::string& pcs_type_name,
