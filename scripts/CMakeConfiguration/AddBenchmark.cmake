...
IF (WIN32)
	...
	EXECUTE_PROCESS (
		...
		WORKING_DIRECTORY ${BENCHMARK_DIR_FOUND})

	EXECUTE_PROCESS (
		COMMAND ${EXECUTABLE_OUTPUT_PATH}/Release/ogs ${benchmarkStrippedName}
		WORKING_DIRECTORY ${BENCHMARK_DIR_FOUND}/${benchmarkDir}
...
ELSE (WIN32)
	...
	IF(OGS_FEM_CONFIG STREQUAL "OGS_FEM_PETSC" OR OGS_FEM_CONFIG STREQUAL "OGS_FEM_MPI")
		SET(MPI_RUN_COMMAND "mpirun" "-np" "${NUM_PROCESSES}")
	ELSE()
		SET(MPI_RUN_COMMAND "")
	ENDIF()

	MESSAGE(STATUS "WORKING_DIRECTORY is ${BENCHMARK_DIR_FOUND}")
	EXECUTE_PROCESS (
		COMMAND rm -f ${FILES_TO_DELETE_VARS}
		WORKING_DIRECTORY ${BENCHMARK_DIR_FOUND})
	IF(OGS_PROFILE AND NOT (OGS_FEM_CONFIG STREQUAL "OGS_FEM_PETSC" OR OGS_FEM_CONFIG STREQUAL "OGS_FEM_MPI"))
		...
		IF(OGS_OUTPUT_PROFILE)
			...
			EXECUTE_PROCESS (
				...
				COMMAND ${DOT_TOOL_PATH} -Tpng -o ${BENCHMARK_DIR_FOUND}/results/${benchmarkStrippedName}.png
				WORKING_DIRECTORY ${BENCHMARK_DIR_FOUND}/${benchmarkDir})
	...
	ELSE()
		EXECUTE_PROCESS (
			...
			WORKING_DIRECTORY ${BENCHMARK_DIR_FOUND}/${benchmarkDir}
			OUTPUT_FILE ${benchmarkStrippedName}.log
			TIMEOUT ${BENCHMARK_TIMEOUT}
			RESULT_VARIABLE EXIT_CODE)
	ENDIF()
